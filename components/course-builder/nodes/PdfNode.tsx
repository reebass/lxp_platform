...
// Custom React Flow node for PDF / Text theoretical material.
const PdfNode = memo(({ id, data }: NodeProps) => {
  ...
  return (
    <div className="group relative bg-background border border-primary/50 rounded-lg shadow-sm px-2.5 py-1.5 min-w-[140px] max-w-[180px]">
      <Handle
        type="target"
