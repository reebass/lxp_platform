...
export const dict = {
  ...
  uk: {
    ...
    course_builder: {
      ...
      node_start: '🚀 Початок',
      node_finish: '🏁 Кінець',
      sidebar_title: 'Елементи курсу',
      node_pdf_title: 'Текст / PDF',
      node_pdf_desc: 'Теоретичний матеріал',
      node_video_title: 'Відео',
      node_video_desc: 'Відеоматеріал',
      node_audio_title: 'Аудіо',
      node_audio_desc: 'Подкаст / лекція',
      node_quiz_title: 'Тест',
      node_quiz_desc: 'Перевірка знань',
      sidebar_settings: 'Налаштування',
      btn_back: 'Назад',
      input_node_name: 'Назва елементу',
      btn_save_node: 'Зберегти',
      default_name_pdf: 'Текст',
      default_name_video: 'Відео',
      default_name_audio: 'Аудіо',
      default_name_quiz: 'Тест',
      tab_manual: 'Ввести вручну',
      tab_upload: 'Завантажити документ',
      tab_ai: 'Згенерувати ШІ',
      content_placeholder: 'Введіть текст матеріалу...',
      badge_coming_soon: 'Незабаром',
      upload_placeholder: 'Завантаження PDF, DOCX, TXT файлів',
      ai_placeholder: 'Автоматична генерація контенту',
      slide: 'Слайд',
      add_slide: 'Додати слайд',
      remove_slide: 'Видалити слайд',
      btn_summarize: 'Резюмувати',
      btn_format_steps: 'Покрокова інструкція',
      btn_suggest_title: 'Запропонувати назву',
      btn_generate_image: 'Згенерувати зображення',
      tab_link_upload: 'Посилання / Файл',
      tab_cloud: 'Google Drive',
      tab_ai_avatar: 'AI Аватар',
      tab_ai_podcast: 'AI Підкаст',
      input_media_url: 'Вставте посилання (YouTube, Vimeo...)',
      input_audio_url: 'Вставте посилання на аудіо',
      or_upload_file: 'або завантажте файл',
      upload_video_hint: 'MP4, до 100 МБ',
      upload_audio_hint: 'MP3, WAV, до 10 МБ',
      cloud_placeholder: 'Оберіть файл з Google Drive',
      ai_avatar_placeholder: 'Згенерувати AI аватар / озвучку',
      ai_podcast_desc: 'Згенеруйте навчальний підкаст у форматі діалогу',
      btn_generate_podcast: 'Згенерувати підкаст',
      badge_premium: 'Premium',
      tab_manual_quiz: 'Створити вручну',
      tab_ai_quiz: 'Згенерувати ШІ',
      add_question: 'Додати питання',
      question_placeholder: 'Текст питання...',
      question_type: 'Тип питання',
      type_single: 'Один варіант',
      type_multiple: 'Кілька варіантів',
      option_placeholder: 'Варіант відповіді...',
      add_option: 'Додати варіант',
      points: 'Балів',
      ai_quiz_desc: 'Згенеруйте тест на основі матеріалів курсу',
      btn_generate_quiz: 'Згенерувати тест',
      toast_save_success: 'Курс збережено',
      toast_save_error: 'Помилка збереження',
      toast_load_error: 'Помилка завантаження курсу',
      btn_saving: 'Збереження...',
      error_access_denied: 'Доступ заборонено',
      error_insufficient_permissions: 'Недостатньо прав для управління курсами',
      ai_generating: 'Генерація...',
      toast_ai_success: 'Текст згенеровано',
      toast_ai_error: 'Помилка генерації',
      ai_empty_slide: 'Спочатку додайте текст до слайду',
      confirm_reset_title: 'Повністю очистити курс?',
      confirm_reset_description: 'Ви впевнені? Усі додані блоки та зв\'язки будуть безповоротно видалені.',
      btn_confirm_reset: 'Так, очистити',
  ...
  en: {
    ...
    course_builder: {
      ...
      node_start: '🚀 Start',
      node_finish: '🏁 Finish',
      sidebar_title: 'Course Elements',
      node_pdf_title: 'Text / PDF',
      node_pdf_desc: 'Theoretical material',
      node_video_title: 'Video',
      node_video_desc: 'Video content',
      node_audio_title: 'Audio',
      node_audio_desc: 'Podcast / lecture',
      node_quiz_title: 'Quiz',
      node_quiz_desc: 'Knowledge check',
      sidebar_settings: 'Settings',
      btn_back: 'Back',
      input_node_name: 'Element Name',
      btn_save_node: 'Save',
      default_name_pdf: 'Text',
      default_name_video: 'Video',
      default_name_audio: 'Audio',
      default_name_quiz: 'Quiz',
      tab_manual: 'Manual Entry',
      tab_upload: 'Upload Document',
      tab_ai: 'Generate with AI',
      content_placeholder: 'Enter content text...',
      badge_coming_soon: 'Coming soon',
      upload_placeholder: 'Upload PDF, DOCX, TXT files',
      ai_placeholder: 'Automatic content generation',
      slide: 'Slide',
      add_slide: 'Add Slide',
      remove_slide: 'Remove Slide',
      btn_summarize: 'Summarize',
      btn_format_steps: 'Format as Steps',
      btn_suggest_title: 'Suggest Title',
      btn_generate_image: 'Generate Image',
      tab_link_upload: 'Link / Upload',
      tab_cloud: 'Google Drive',
      tab_ai_avatar: 'AI Avatar',
      tab_ai_podcast: 'AI Podcast',
      input_media_url: 'Paste link (YouTube, Vimeo...)',
      input_audio_url: 'Paste audio link',
      or_upload_file: 'or upload a file',
      upload_video_hint: 'MP4, up to 100 MB',
      upload_audio_hint: 'MP3, WAV, up to 10 MB',
      cloud_placeholder: 'Select file from Google Drive',
      ai_avatar_placeholder: 'Generate AI avatar / voiceover',
      ai_podcast_desc: 'Generate a conversational educational podcast',
      btn_generate_podcast: 'Generate Podcast',
      badge_premium: 'Premium',
      tab_manual_quiz: 'Manual Creation',
      tab_ai_quiz: 'Generate with AI',
      ...
      points: 'Points',
      ai_quiz_desc: 'Generate quiz from course content',
      btn_generate_quiz: 'Generate Quiz',
      toast_save_success: 'Course saved',
      toast_save_error: 'Save failed',
      toast_load_error: 'Failed to load course',
      btn_saving: 'Saving...',
      error_access_denied: 'Access denied',
      error_insufficient_permissions: 'Insufficient permissions to manage courses',
      ai_generating: 'Generating...',
      toast_ai_success: 'Text generated',
      toast_ai_error: 'Generation failed',
      ai_empty_slide: 'Add text to the slide first',
      confirm_reset_title: 'Clear entire course?',
      confirm_reset_description: 'Are you sure? All added blocks and connections will be permanently deleted.',
      btn_confirm_reset: 'Yes, clear',
      btn_cancel: 'Cancel',
    },
    admin: {
      sidebar: {
